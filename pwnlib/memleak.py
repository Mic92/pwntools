...
class MemLeak(object):
    ...
    Example:
        ...
        >>> memory = {-4+i: c.encode('ascii') for i,c in enumerate('wxyzABCDE')}
    ...
    def b(self, addr, ndx = 0):
        ...
        Examples:
            ...
            >>> import string, six
            >>> data = six.b(string.ascii_lowercase)
    ...
    def _clear(self, addr, ndx, size):
        ...
        return unpack(b''.join(map(six.int2byte, six.iterbytes(data))), size*8)
